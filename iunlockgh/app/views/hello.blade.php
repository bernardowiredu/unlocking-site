...
<html lang="en">
  ...
  <div id="fb-root"></div>
    ...
    <div class="container ">
      ...
      <!-- Static navbar -->
      <nav class="navbar navbar-inverse navbar-fixed-top blck">
    ...
    <div class="thumbnail">
      <img class="pull-right" src="img/iphone-66.jpg" alt="product" width="140" height="160">
       ...
       <p class="">Supported devices: <p></p><span class="yellow"><b>iPhone 4/4S/5/5C/5S/6/6+</b></span></p>
        ...
        <a class="btn btn-block btn-primary" role="button" data-toggle="collapse" href="#collapseExample4" aria-expanded="false" aria-controls="collapseExample">
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p>Alerts don't have default classes, only base and modifier classes. A default gray alert doesn't make too much sense</p>
         <p class="">Supported devices: <p></p><span class="yellow"><b>iPhone 4/4S/5/5C/5S/6/6+</b></span></p>
         <p class="">Delivery Time: <span class="yellow"><b>1-7days</b></span></p>
        <a class="btn btn-block btn-primary" role="button" data-toggle="collapse" href="#collapseExample2" aria-expanded="false" aria-controls="collapseExample">
            Unlock Phone at GH₵ 50.00
          </a>
      ...
      <div class="caption">
       <h4><strong>Virgin</strong></h4>
        <p>Alerts don't have default classes, only base and modifier classes. A default gray alert doesn't make too much sense</p>
         <p class="">Supported devices: <p></p><span class="yellow"><b>iPhone 4/4S/5/5C/5S/6/6+</b></span></p>
         <p class="">Delivery Time: <span class="yellow"><b>1-7days</b></span></p>
        <a class="btn btn-block btn-primary" role="button" data-toggle="collapse" href="#collapseExample3" aria-expanded="false" aria-controls="collapseExample">
...
<div class="nav"><!-- blk -->
  ...
  <h4 class="blue"><img src="../public/img/phone1.png" class="hidden-xs" alt="pic" width="70" height="70" > <b>Free your phone from your network with our Unlock Codes and use any GSM Sim!</b></h4>
  <p class="push">Planning on traveling and need to put a local SIM card into your Phone? Want to change carriers but keep your phone? 
   You may need to unlock your phone in order to use a different SIM card. You've certainly come to the right place!</p>
    ...
    <h4 class="blue"><img src="../public/img/time_machine.png"  class="hidden-xs" alt="pic" width="70" height="70" ><b> Phone Unlock Code Processed & Emailed - 24 hrs a day - 7 days a week</b></h4>
   ...
   guarantying Faster Results and 100% Customer Services Satisfaction.</p>
    ...
    <h4 class="blue"><img src="../public/img/earth.png"  class="hidden-xs" alt="pic" width="65" height="65" ><b> We can Unlock 99% of the GSM Networks</b></h4>
   <p class="push">At iunlockGh we can unlock most of the GSM Networks around the world. If you are trying to unlock a phone in Europe, America, Asia, Australia and over 190 Countries in the World, give us the challenge and you won't regret. We count with the largest database of unique Unlock Codes and Unlocking solutions in Earth.
    We can even unlock the phones which Service Providers claim cannot be unlocked</p>
     ...
     <h4 class="blue"><img src="../public/img/unlock.png"  class="hidden-xs" alt="pic" width="70" height="70" ><b>We offer the LOWEST COST & QUICKEST TURNAROUND on every order.</b></h4>
    ...
    Skype or E-mail from Mon to Fri 10.00 to 20.00 hrs GMT.</p>
     ...
     <h4 class="blue"><img src="../public/img/microphone.png"  class="hidden-xs" alt="pic" width="70" height="70" ><b>Do you provide unlocking services and you need lots of codes?</b></h4>
