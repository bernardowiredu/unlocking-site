...
<div class="nav">
  <div class="span7">
	...
	<img src="img/locker.png" class="img-responsive" width="300" height="300">
  ...
  <p>
	...
	<div class="col-sm-6 col-md-5 f5">
     ...
     {{ Form::open(array('url' => 'login', 'method'=>'POST', 'class' => 'form-signin')) }}
      ...
      @include('common.notification')
        ...
        <div class="checkbox">
          <label>
            <input type="checkbox" value="remember-me"> <span class="whyt">Remember me</span> 
          </label>
        </div>
      ...
      <p class="text-center"><a href="{{URL::to('forgotten-password')}}"><font color="#fff">Forgotten password ? click here</font></a></p>
       ...
       <h3 class="text-primary text-center">I'm a new customer</h3>
        <p class="text-center whyt">You can create an account in just a few simple steps. Click below to begin.</p>
        <p></p>
       {{Form::close()}}
