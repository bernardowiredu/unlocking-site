...
<h1 class="blue animated bounceInLeft" data-id='1'>Forgot your password?</h1>
...
<footer class="bgn text-center">
      <div class="inline">
        <p class="blck2">Copyright &copy; 2015 iunlockgh.com all rights reserved. <a href="">Terms and conditions</a>
        <ul class="nav">
        </ul>
        </p>
      </div>
